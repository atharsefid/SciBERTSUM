...
if __name__ == '__main__':
    ...
    # parser.add_argument("-max_pos", default=1024, type=int) #fix
    ...
    parser.add_argument('-attention_window', default=6, type=int,help=" size of the local attention window")
    ...
    parser.add_argument("-ext_layers", default=4, type=int, help="number of extractive encoder layers")
    ...
    parser.add_argument("-optim", default='adadelta', type=str)
    ...
    parser.add_argument("-accum_count", default=10, type=int) # this is the gradient accumulation count ( like batch size)
    ...
    parser.add_argument("-num_sample_rollout", type=int, default=20)  # number of the oracle summaries generated for the reinforced learning
