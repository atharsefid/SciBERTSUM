...
class LongformerSelfAttention(nn.Module):
    ...
    def forward(
        ...
        if is_global_attn:
            ...
            (
                ...
                is_local_index_global_attn_nonzero, # location of the non-padding values within global attention indices
                is_local_index_no_global_attn_nonzero, # location of the padding values within global attention indices
        ...
        # ################################ calculate attn_output = attn_prob * value ###################################
    ...
    def _compute_attn_output_with_global_indices(
        ...
        '''
        attn_probs_only_global * value_vectors_only_global + attn_probs_without_global * value_vectors
        '''
    ...
    def _compute_global_attn_output_from_hidden(
        ...
        '''
        function summary
        attn_prob = query_global_only * key
        attn_output = attn_prob * value
        Pay attention that query is global only and the others are full vectors
        '''
