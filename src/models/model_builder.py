...
class ExtSummarizer(nn.Module):
    ...
    def forward(self, src, sections, token_sections, segs, clss, mask_src, mask_cls, media, references):
        ...
        sent_scores = self.extraction_model(inputs_embeds, sent_lens, sections, attention_mask, extended_attention_mask, media, references)
        return sent_scores
